...
public class DriveTrain extends Subsystem {
	...
	//CANTalon objects
	public CANTalon backLeft = new CANTalon(RobotMap.frontLeftPort);
	public CANTalon backRight = new CANTalon(RobotMap.frontRightPort);
	public CANTalon frontLeft = new CANTalon(RobotMap.backLeftPort);
	public CANTalon frontRight = new CANTalon(RobotMap.backRightPort);
	...
	public DriveTrain(){
		...
		frontRight.setFeedbackDevice(FeedbackDevice.QuadEncoder);
		backLeft.set(RobotMap.backLeftPort);
		backRight.set(RobotMap.backRightPort);
